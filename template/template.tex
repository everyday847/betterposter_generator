...
% Main column font
\renewcommand{\fontsizemain}{\fontsize{84.00}{96} \selectfont}
% Title font
...
\title{High resolution RNA structure prediction and design}
\author{Andrew M. Watkins}
\author{Rhiju Das}
\institution{Stanford University}


\textbf{Blind prediction} of structured RNAs
\\can be achieved at \textbf{high resolution}
\\using the \textbf{stepwise Monte Carlo} algorithm
}{
%%%% Bottom space
...
Noncoding RNAs fold into defined 3D structures just like proteins, but traditional methods for structure prediction 
\begin{itemize}
\item The first item.
...
\includegraphics[width=\textwidth]{img/Stanford_S.eps}
\end{center}
